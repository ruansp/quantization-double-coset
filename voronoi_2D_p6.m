...
tile(1).face_x = 2.0 * [4.0, 8.0, 4.0, -4.0, -8.0, -4.0] / 8.0;
tile(1).face_y = 2.0 * [7.0, 0.0, -7.0, -7.0, 0.0, 7.0] / 8.0;
tile(1).face_z = pi * ones (1, 6) / 6.0;

tile(2).face_x = 2.0 * [4.0, 8.0, 4.0, -4.0, -8.0, -4.0] / 8.0;
tile(2).face_y = 2.0 * [7.0, 0.0, -7.0, -7.0, 0.0, 7.0] / 8.0;
tile(2).face_z = -pi * ones (1, 6) / 6.0;
...
tile(3).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 6.0;
...
tile(4).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 6.0;
...
tile(5).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 6.0;
...
tile(6).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 6.0;
...
tile(7).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 6.0;
...
tile(8).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 6.0;
...
zticks ([-pi/6, 0.0, pi/6]);
zticklabels ({'$-\frac{\pi}{6}$', '0', '$\frac{\pi}{6}$'});
