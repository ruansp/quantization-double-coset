...
tile(3).face_z = 0.5 * pi * [1.0, 1.0, -1.0, -1.0];
...
tile(4).face_z = 0.5 * pi * [1.0, 1.0, -1.0, -1.0];
...
tile(5).face_z = 0.5 * pi * [1.0, 1.0, -1.0, -1.0];
...
tile(7).face_z = 0.5 * pi * [1.0, 1.0, -1.0, -1.0];
...
tile(8).face_z = 0.5 * pi * [1.0, 1.0, -1.0, -1.0];
