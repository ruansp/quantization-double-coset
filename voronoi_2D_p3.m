...
tile(3).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 3.0;
...
tile(4).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 3.0;
...
tile(5).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 3.0;
...
tile(6).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 3.0;
...
tile(7).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 3.0;
...
tile(8).face_z = pi * [1.0, 1.0, -1.0, -1.0] / 3.0;
...
zticks ([-pi/3, 0.0, pi/3]);
zticklabels ({'$-\frac{\pi}{3}$', '0', '$\frac{\pi}{3}$'});
